...
def get_secret(env_var, default=None):
    ...
    Docker Swarm stores secrets in /run/secrets/<name>.
    If a _FILE variant of the env var exists, read the secret from that file.
    Otherwise, fall back to the regular environment variable.
    """
...
DB_CONFIG = {
    ...
    'password': get_secret('DB_PASSWORD', 'logs_password'),
